...
// Notes to Grader:
package pappybuck_test_engineer_1.src.test;
...
public class backend_test {
  ...
  public void load_test(){
    ...
    assertTrue(test.listCities()[0].equals("Asheville"), "Test 1 Failed");
    assertTrue(test.listCities()[5].equals("Chicago"), "Test 2 Failed");
    assertTrue(test.listCities()[11].equals("Los Angeles"), "Test 3 Failed");
    assertTrue(test.listCities()[17].equals("Portland"), "Test 4 Failed");
    assertTrue(test.listCities()[26].equals("Twin Cities"), "Test 5 Failed");
